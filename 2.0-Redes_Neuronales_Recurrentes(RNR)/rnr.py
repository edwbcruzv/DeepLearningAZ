...
# =============================================================================
# Una red recurrente e suna arquitectura que permite analizar secuencias (Recurrencia)
# Hidden State: se encarga de almacenar dicha recurrencia


# =============================================================================
# Objetivo: Entrenar una red neuronal con dataset de nombre de dinusarios
# y depsues al ingresar un caracter este prediga o complete el nombre d eun dinosaurio
# =============================================================================
...
from keras.layers import Input, Dense, SimpleRNN # celda recurrente
from keras.models import Model
from keras.optimizers import SGD  #gradiente descendiente
...
# =============================================================================
# 3-Implemetacion en keras (modelo)
# =============================================================================
